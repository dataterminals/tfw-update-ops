...
>
> **2026-09-22 — two of those six are done:** `forever-winter-datamine` and `forever-winter-almanac` are restamped to `25071553` from a full 722-dump re-decode (gate 2 🟩, 1b corroborated). The almanac is **committed but not deployed** — Pages still serves `24536482` until it is pushed. See both Class C rows.
>
